...
import com.uon.loanmanagement.databinding.FragmentEditBinding
...
class EditFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loanViewModel.distinctLoanerName.observe(viewLifecycleOwner){
            val adapter = ArrayAdapter<String>(
                binding.editLoanerNameAutoCompleteTextView.context,
                androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,
                it
            )
            binding.editLoanerNameAutoCompleteTextView.setAdapter(adapter)
        }
    ...
    private fun showDatePickerDialog() {
        ...
        val datePickerDialog = DatePickerDialog(requireContext(),{
            ...
            binding.editDateTextView.text = formattedDate
